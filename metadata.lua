return PlaceObj('ModDef', {
	...
	'last_changes', "5.1 Updated to update version number.\n\n#1 Bugfix: Ensured all animals are correctly connected to a 3d model and their animations\n\n#2 Bugfix: Fixed bug in code when Ulfen evolutions do their special thing\n\n#3 QA: Added a test spawn of every animal in QA function to ensure no repeat of Bug fixed in #1\n\n#4 QA: Added save game fixup code to tell already spawned but invisible animals to remember what body they are suppose to be. And they will put on their correct body.\n\nPlease see the git in the mod description for open bugs, and even submit your own\nFeedback is always welcome to fine tune the balance of things!",
	'dependencies', {

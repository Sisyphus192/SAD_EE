...
PlaceObj('ModItemFolder', {
	...
	PlaceObj('ModItemFolder', {
		...
		PlaceObj('ModItemUnitAnimalCompositeDef', {
			...
			'DisplayName', T(--[[ModItemUnitAnimalCompositeDef gasbag_t5 DisplayName]] "BadTrip Bloated Glutch Stitcher"),
			'DisplayNamePl', T(--[[ModItemUnitAnimalCompositeDef gasbag_t5 DisplayNamePl]] "BadTrip Bloated Glutch Stitcher"),
			'DisplayNameUnknown', T(--[[ModItemUnitAnimalCompositeDef gasbag_t5 DisplayNameUnknown]] "Glutch Final Form?"),
			'DisplayNameUnknownPL', T(--[[ModItemUnitAnimalCompositeDef gasbag_t5 DisplayNameUnknownPL]] "Glutch Final Form?"),
			'Description', T(214081077243, --[[ModItemUnitAnimalCompositeDef gasbag_t5 Description]] "This Glutch can repair itself almost instantly. Beware the long term effects of it's attacks! Dedicated firepower to pierce it like a balloon is needed. VERY resistant to gas/blunt attacks. Deals <color TextPositive>Gas</color> damage."),
		...
		PlaceObj('ModItemUnitAnimalCompositeDef', {
			...
			'lead_priority', 10,
			'Icon', "UI/Icons/Resources/res_glutch_red",
			'DisplayName', T(--[[ModItemUnitAnimalCompositeDef gasbag_t3 DisplayName]] "Bloated Glutch"),
			'DisplayNamePl', T(--[[ModItemUnitAnimalCompositeDef gasbag_t3 DisplayNamePl]] "Bloated Glutch"),
			'DisplayNameUnknown', T(391697098875, --[[ModItemUnitAnimalCompositeDef gasbag_t3 DisplayNameUnknown]] "Unknown Glutch Evolution"),
			'DisplayNameUnknownPL', T(302967091218, --[[ModItemUnitAnimalCompositeDef gasbag_t3 DisplayNameUnknownPL]] "Unknown Glutch Evolution"),
			'Description', T(879688403975, --[[ModItemUnitAnimalCompositeDef gasbag_t3 Description]] "Retaining their regenerative properties, but are immensely bulkier than their last species. Dedicated firepower to pierce it like a balloon is needed. VERY resistant to gas/blunt attacks. Deals <color TextPositive>Gas</color> damage."),
			'fx_actor_base_class', "Glutch",
			'BaseMaxHealth', 500000,
			'FoodResources', {
				"FoodAnimalHerbivore",
		...
		PlaceObj('ModItemUnitAnimalCompositeDef', {
			...
			'lead_priority', 10,
			'Icon', "UI/Icons/Resources/res_glutch_red",
			'DisplayName', T(302321161779, --[[ModItemUnitAnimalCompositeDef gasbag_t2 DisplayName]] "Glutch Stitcher"),
			'DisplayNamePl', T(165059518040, --[[ModItemUnitAnimalCompositeDef gasbag_t2 DisplayNamePl]] "Glutch Stitcher"),
			'DisplayNameUnknown', T(857757081108, --[[ModItemUnitAnimalCompositeDef gasbag_t2 DisplayNameUnknown]] "Unknown Glutch Evolution"),
			'DisplayNameUnknownPL', T(667700344725, --[[ModItemUnitAnimalCompositeDef gasbag_t2 DisplayNameUnknownPL]] "Unknown Glutch Evolution"),
			'Description', T(152349153102, --[[ModItemUnitAnimalCompositeDef gasbag_t2 Description]] "These Glutches are able to regenerate their wounds. Must be due to thier skin being largely gasseous. Dedicated firepower to pierce it like a balloon is needed. VERY resistant to gas/blunt attacks. Deals <color TextPositive>Gas</color> damage."),
			'fx_actor_base_class', "Glutch",
			'FoodResources', {
				"FoodAnimalHerbivore",
				"Slop",
		...
		PlaceObj('ModItemUnitAnimalCompositeDef', {
			'Group', "scarabs",
			'Id', "Skarabei_Manhunting_Explosive",
			'object_class', "GroundAnimal",
			'SpeciesGroup', "species_skarabei",
			'pfclass', 5,
			'composite_part_groups', {
		...
		PlaceObj('ModItemUnitAnimalCompositeDef', {
			'Group', "scarabs",
			'Id', "Skarabei_Manhunting_Poisonous",
			'object_class', "GroundAnimal",
			'SpeciesGroup', "species_skarabei",
			'composite_part_groups', {
				"Skarabei_Manhunting",
		...
		PlaceObj('ModItemUnitAnimalCompositeDef', {
			'Group', "scarabs",
			'Id', "Skarabei_Manhunting_Starving",
			'object_class', "GroundAnimal",
			'SpeciesGroup', "species_skarabei",
			'composite_part_groups', {
				"Skarabei_Manhunting",

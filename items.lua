...
PlaceObj('ModItemFolder', {
	...
	PlaceObj('ModItemDeviceInterface', {
		id = "ee_tame",
		prg_name = "TameManagement",
		save_in = "Mod/rtw6tLg",
		spot_name = "Tamecraftinginterface",
	}),
	PlaceObj('ModItemRecipe', {
		Activity = "Husbandry",
		ActivityDuration = 160000,
		BuildCategory = "ee_husbandry",
		Description = T(298531648984, --[[ModItemRecipe ee_husbandry_train Description]] "Show our herd via VR combat scenarios, granting each  5x combat xp."),
		DeviceWorkTime = 0,
		DisplayName = T(743872629451, --[[ModItemRecipe ee_husbandry_train DisplayName]] "Mass Training"),
		FailChance = 33,
		GuaranteedSuccessLevel = 5,
		HasIntermediateResult = false,
		Icon = "UI/Icons/Research/improved_vr_games",
		LockState = "hidden",
		ManualWork = true,
		MinSkillLevel = 3,
		...
		OutputResources = {
			PlaceObj('ResAmount', {
				'resource', "husbandry_output",
			}),
		},
		RequiredDeviceInterfaces = {
			"ee_tame",
		},
		ShowActionInDirectOrder = false,
		id = "ee_husbandry_train",
		save_in = "Mod/rtw6tLg",
	}),
	PlaceObj('ModItemRecipe', {
		Activity = "Husbandry",
		...
		BuildCategory = "ee_husbandry",
		Description = T(900919168771, --[[ModItemRecipe ee_husbandry_study Description]] "Learn about the animals from scratch!<newline><style TextNegative>Will not grant XP unless colonist has a Farming skill of 8+</style>"),
		DeviceWorkTime = 0,
		DisplayName = T(823829197015, --[[ModItemRecipe ee_husbandry_study DisplayName]] "Study Animal Behavior"),
		FailChance = 50,
		GuaranteedSuccessLevel = 4,
		HasIntermediateResult = false,
		Icon = "Mod/rtw6tLg/picsOrItDidntHappen/Husbandry.png",
		LockState = "hidden",
		ManualWork = true,
		OutputResources = {
			PlaceObj('ResAmount', {
		...
		ShowActionInDirectOrder = false,
		id = "ee_husbandry_study",
		save_in = "Mod/rtw6tLg",
	}),
	PlaceObj('ModItemBuildCategory', {
		ActionText = T(380234486150, --[[ModItemBuildCategory Default ee_husbandry ActionText |gender-variants]] "Managing the non-unionized workforce"),
		Description = T(793346714408, --[[ModItemBuildCategory Default ee_husbandry Description]] "For when your herd of flesh eating/disintegrating/burning creatures need more love"),
		DisplayName = T(469464465188, --[[ModItemBuildCategory Default ee_husbandry DisplayName]] "Husbandry"),
		Icon = "UI/Icons/Research/animal_taming",
		SortKey = 2,
		id = "ee_husbandry",
		save_in = "Mod/rtw6tLg",
	}),
	PlaceObj('ModItemResource', {
		ConsumerTags = set( "Android", "Human" ),
		DecayRateOutside = 174,
		DecayTimeOutside = 23040000,
		LockState = "hidden",
		MinStorageCondition = 2,
		SortKey = 630,
		alt_icon = "UI/Icons/Items/short_story",
		anim_pile_load = "standing_PickUp_HandsClose",
		anim_pile_unload = "standing_DropDown_HandsClose_High",
		carry_amount = 50000,
		...
		description = T(545194831894, --[[ModItemResource husbandry_output description]] "A small scientific article explaining how to not get killed on this planet"),
		display_name = T(710260839368, --[[ModItemResource husbandry_output display_name]] "Thesis"),
		display_name_pl = T(885178261797, --[[ModItemResource husbandry_output display_name_pl]] "Scientific Literature"),
		group = "OtherItems",
		happiness_factor = "Read",
		health_condition = "Inspiration",
		health_condition_chance = 100,
		icon = "UI/Icons/Resources/short_story",
		id = "husbandry_output",
		in_groups = {
			"Other",
			"Other_Infobar",
		...
		progress = 12000,
		quality = 50,
		relaxation_routine = "Reading",
		save_in = "Mod/rtw6tLg",
		serving_nutrition = 0,
		stack_entity = "ResourceBulk_Paper",
	...
	PlaceObj('ModItemRecipe', {
		...
		BuildCategory = "ee_husbandry",
		Description = T(897113757238, --[[ModItemRecipe ee_shrieker_durability Description]] "Improving Shrieker's survivability.<newline><style TextNegative>Only one improvement per species allowed.</style>"),
		DisplayName = T(500449329387, --[[ModItemRecipe ee_shrieker_durability DisplayName]] "Shrieker Durability"),
		Icon = "Mod/rtw6tLg/picsOrItDidntHappen/armor-blueprint.png",
		InputResources = {
			PlaceObj('ResAmount', {
				'resource', "HoneyBites",
				'amount', 5000,
		...
		OnOutputResourceCompleted = function (self, device, unit, res, amount, res_info)
			...
			local player = unit.player or UIPlayer
			local effect = PlaceObject("ModifyObject")
		end,
		OutputResources = {
			PlaceObj('ResAmount', {
				'resource', "Slop",
	...
	PlaceObj('ModItemRecipe', {
		...
		ActivityDuration = 10000,
		BuildCategory = "ee_husbandry",
		Description = T(895771213634, --[[ModItemRecipe ee_shrieker_range Description]] "Improving Shrieker's range.<newline><style TextNegative>Only one improvement per species allowed.</style>"),
		DisplayName = T(135371217694, --[[ModItemRecipe ee_shrieker_range DisplayName]] "Shrieker Range"),
		Icon = "UI/Icons/Build Menu/hunt",
		InputResources = {
			PlaceObj('ResAmount', {
				'resource', "HoneyBites",
				'amount', 5000,
		...
		id = "ee_shrieker_range",
		save_in = "Mod/rtw6tLg",
	}),
	PlaceObj('ModItemEntity', {
		'name', "OutdoorCrafting",
		'entity_name', "OutdoorCrafting",
		'material', {
			"OutdoorCrafting_OutdoorCrafting",
		},
		'mesh', {
			"OutdoorCrafting_OutdoorCrafting.m",
		},
		'texture', {
			"10062000",
			"10062001",
